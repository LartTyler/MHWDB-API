<?php
	 ...
	 */
	final class Version20200214023728 extends AbstractMigration {
		...
		public function up(Schema $schema): void {
			...
			$this->addSql('ALTER TABLE quests ADD CONSTRAINT FK_989E5D3420AAC085 FOREIGN KEY (endemic_life_id) REFERENCES endemic_life (id)');
		...
		public function down(Schema $schema): void {
			...
			$this->addSql('ALTER TABLE quests DROP FOREIGN KEY FK_989E5D3420AAC085');
